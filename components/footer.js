...
export default function Footer() {
  return (
    <footer className="bg-black text-gray-400 py-6 mt-12">
        <div className="container mx-auto flex px-6 pb-5 flex-col md:flex-row items-center">
            <img src="/logo.svg" alt="Logo" width={20} height={20} /> 
            <p className="uppercase pl-0.5 text-2xl font-extrabold text-white"> Librarium </p>
        </div>
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        <p className="text-sm">&copy; {new Date().getFullYear()} DevCow. All rights reserved.</p>
        <div className="mt-4 md:mt-0 flex space-x-6">
          <a
            href="https://github.com/devcow85/librarium"
            target="_blank"
