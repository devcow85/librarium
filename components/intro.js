...
import {Award, Briefcase, Mail, ChevronUp,ChevronDown} from '@geist-ui/icons'
      ...
      <div className="grid md:grid-cols-3 gap-px bg-gray-700 border border-gray-700 rounded-lg overflow-hidden">
        ...
        <div className="md:col-span-2 bg-black p-8 md:p-12">
          <div className="flex items-start gap-5 mb-2">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-extrabold leading-snug uppercase">
                {name}
              </h1>
              <h2 className="mt-1 text-lg font-semibold text-gray-100 ">
                {position}
              </h2>
              <h2 className="text-gray-400 mb-4 mt-4 text-sm md:text-base">
                {description}
              </h2>
            </div>
          </div>
        ...
        <div className="bg-black p-8 md:p-12 flex flex-col">
          ...
          <h4 className="text-gray-400 mb-6 text-sm md:text-base">
